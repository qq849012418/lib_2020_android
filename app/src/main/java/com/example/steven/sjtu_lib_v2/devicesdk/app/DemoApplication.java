package com.example.steven.sjtu_lib_v2.devicesdk.app;
...
//import com.example.steven.sjtu_lib_v2.devicesdk.demo.R;
import com.example.steven.sjtu_lib_v2.R;
import com.example.steven.sjtu_lib_v2.devicesdk.manager.IDemoCallback;
import com.example.steven.sjtu_lib_v2.devicesdk.manager.InitManager;
...
public class DemoApplication extends Application {
     ...
     * 2.创建一个设备，在文件中(raw/deviceinfo_fortest2)填写改设备信息 productKey，deviceName， productSecret;
    ...
    public String getFromRaw() {
        ...
        try {
            inputReader = new InputStreamReader(getResources().openRawResource(R.raw.deviceinfo_fortest2));
